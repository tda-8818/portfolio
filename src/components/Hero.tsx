                ...
                <div className="text-center space-y-8 animate-fade-in">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className={`text-lg md:text-xl max-w-2xl mx-auto leading-relaxed animate-slide-up delay-300 ${isDark ? 'text-gray-400' : 'text-gray-600'
                            ...
                            I build full-stack MERN applications and enjoy innovating with AI and code to make my life easier.
                            Let's create something amazing together! (ﾐⓛᆽⓛﾐ)✧
                        </p>
                    </div>
                    ...
                    <div className="flex justify-center space-x-6 animate-slide-up delay-700">
                        <a href="https://github.com/tda-8818" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-full transition-all duration-200 hover:scale-110 ${isDark ? 'bg-gray-800/70 hover:bg-gray-700/70 text-white backdrop-blur-sm' : 'bg-white/70 hover:bg-white/90 text-gray-700 shadow-lg backdrop-blur-sm'
                            }`}>
                        ...
                        <a href="https://www.linkedin.com/in/elsa-tsia/" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-full transition-all duration-200 hover:scale-110 ${isDark ? 'bg-gray-800/70 hover:bg-gray-700/70 text-white backdrop-blur-sm' : 'bg-white/70 hover:bg-white/90 text-gray-700 shadow-lg backdrop-blur-sm'
                            }`}>
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
