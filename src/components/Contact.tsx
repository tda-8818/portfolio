      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-12">
          <a
            ...
            download
            className={`inline-flex items-center px-8 py-4 text-lg font-medium rounded-lg transition-all duration-200 transform hover:scale-105 hover:shadow-lg ${isDark
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <a href="mailto:ejj_t@outlook.com" className="flex items-center justify-center space-x-4 group">
            <div className={`p-3 rounded-full transition-transform group-hover:scale-105 ${isDark ? 'bg-blue-500/20 text-blue-400' : 'bg-blue-500/20 text-blue-600'
              }`}>
          ...
          <div className="flex items-center justify-center space-x-4">
            <div className={`p-3 rounded-full ${isDark ? 'bg-blue-500/20 text-blue-400' : 'bg-blue-500/20 text-blue-600'
              }`}>
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
